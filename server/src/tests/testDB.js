...
const populateData = async () => {
    ...
    try {
        ...
        // Create reviews
        console.log('\n⭐ Creating reviews...');
        await createReview(user1._id, 'eiffel-tower', 'Eiffel Tower', 5, 'Absolutely breathtaking views! The lights at night are magical.');
        console.log('✅ Alice reviewed Eiffel Tower');
        await createReview(user1._id, 'colosseum', 'Colosseum', 4, 'Incredible historical site. The guided tour was informative.');
        console.log('✅ Alice reviewed Colosseum');
        await createReview(user2._id, 'great-wall', 'Great Wall of China', 5, 'An unforgettable hike with stunning vistas.');
